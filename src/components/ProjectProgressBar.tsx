    ...
    <div className="space-y-2">
      ...
      <div className="flex gap-4 text-[11px] text-muted-foreground">
        <span className="flex items-center gap-1">
          <span className="w-2 h-2 rounded-full" style={{ background: 'hsl(var(--column-done))' }} /> Done {done}
        </span>
        <span className="flex items-center gap-1">
          <span className="w-2 h-2 rounded-full" style={{ background: 'hsl(var(--column-progress))' }} /> In Progress {inProgress}
        </span>
        <span className="flex items-center gap-1">
          <span className="w-2 h-2 rounded-full" style={{ background: 'hsl(var(--column-todo))' }} /> Todo {total - done - inProgress}
        </span>
      </div>
    </div>
  );
